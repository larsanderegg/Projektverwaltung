...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    @Autowired
    ActivityService ApplicationConversionServiceFactoryBean.activityService;
    
    @Autowired
    DocumentReferenceService ApplicationConversionServiceFactoryBean.documentReferenceService;
    
    @Autowired
    EmployeeService ApplicationConversionServiceFactoryBean.employeeService;
    
    @Autowired
    FinanceResourceService ApplicationConversionServiceFactoryBean.financeResourceService;
    
    @Autowired
    MilestoneService ApplicationConversionServiceFactoryBean.milestoneService;
    
    @Autowired
    PersonalResourceService ApplicationConversionServiceFactoryBean.personalResourceService;
    
    @Autowired
    PhaseService ApplicationConversionServiceFactoryBean.phaseService;
    
    @Autowired
    ProcessModelService ApplicationConversionServiceFactoryBean.processModelService;
    ...
    public Converter<Activity, String> ApplicationConversionServiceFactoryBean.getActivityToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ch.lan.teko.model.Activity, java.lang.String>() {
            public String convert(Activity activity) {
                return new StringBuilder().append(activity.getName()).append(' ').append(activity.getStartDate()).append(' ').append(activity.getEndDate()).append(' ').append(activity.getPlanedStartDate()).toString();
            }
        };
    }
    ...
    public Converter<FinanceResource, String> ApplicationConversionServiceFactoryBean.getFinanceResourceToStringConverter() {
    ...
    public Converter<Long, FinanceResource> ApplicationConversionServiceFactoryBean.getIdToFinanceResourceConverter() {
    ...
    public Converter<String, FinanceResource> ApplicationConversionServiceFactoryBean.getStringToFinanceResourceConverter() {
    ...
    public Converter<Phase, String> ApplicationConversionServiceFactoryBean.getPhaseToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ch.lan.teko.model.Phase, java.lang.String>() {
            public String convert(Phase phase) {
                return new StringBuilder().append(phase.getName()).append(' ').append(phase.getReviewDate()).append(' ').append(phase.getApprovalDate()).append(' ').append(phase.getPlanedReviewDate()).toString();
            }
        };
    }
    ...
    public Converter<Project, String> ApplicationConversionServiceFactoryBean.getProjectToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<ch.lan.teko.model.Project, java.lang.String>() {
            public String convert(Project project) {
                return new StringBuilder().append(project.getName()).append(' ').append(project.getProgress()).append(' ').append(project.getApprovalDate()).append(' ').append(project.getDescription()).toString();
            }
        };
    }
